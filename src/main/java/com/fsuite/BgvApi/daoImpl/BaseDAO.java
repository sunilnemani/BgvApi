...
public class BaseDAO
{
	...
	@PersistenceContext(unitName = "interBgvEntityManager")
	@Qualifier("interEntityManagerFactory")
	protected EntityManager interManager;

	@PersistenceContext(unitName = "actBgvEntityManager")
	@Qualifier("actEntityManagerFactory")
	protected EntityManager actManager;
