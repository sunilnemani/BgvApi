...
public class Commons
{
	...
	public static BaseResponseDTO getSuccessResponse(String code,String message)
	{
		return getBaseResponseDTO(code, message,BaseResponseDTO.SUCCESS_STATUS);
	}

	public static BaseResponseDTO getFailureResponse(String code,String message)
	{
		return getBaseResponseDTO(code, message, BaseResponseDTO.FAILURE_STATUS);
	}

	public static BaseResponseDTO getBaseResponseDTO(String respCode,String respDesc,String STATUS)
	{
